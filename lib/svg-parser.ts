...
import { FONT_REGISTRY, MEASUREMENT_FONT_EXTRAS } from '@/lib/fonts'
...
const MEASUREMENT_FONT_REGISTRY = [
  ...FONT_REGISTRY.map(({ file, family, weight }) => ({ path: getFontPath(file), family, weight })),
  ...MEASUREMENT_FONT_EXTRAS,
]
